...
<body>
        ...
        <main class="main-content">
            <header class="main-header">
                <div class="header-title">
                    <h2>Base64编码</h2>
                    <p>在线Base64编码和解码工具，支持文本和URL安全Base64编码</p>
                </div>
            </header>
            ...
            <div class="tool-container">
                ...
                <div class="tool-content">
                    ...
                    <div class="tab-content active" id="encode">
                        ...
                        <div class="options">
                            <div class="option-item">
                                <input type="checkbox" id="url-safe" name="url-safe" value="1">
                                <label for="url-safe">URL安全编码</label>
                            </div>
                            <div class="option-item">
                                <input type="checkbox" id="add-padding" name="add-padding" value="1" checked>
                                <label for="add-padding">添加填充字符</label>
                            </div>
                        </div>
                        
                        <div class="input-section">
                            <label for="encode-input" class="input-label">输入文本</label>
                            <textarea class="input-textarea" id="encode-input" placeholder="请输入要编码的文本..."></textarea>
                        </div>
                        ...
                        <div class="output-section">
                            <label for="encode-output" class="output-label">Base64编码结果</label>
                    ...
                    <div class="tab-content" id="decode">
                        ...
                        <div class="options">
                            <div class="option-item">
                                <input type="checkbox" id="strict-decode" name="strict-decode" value="1">
                                <label for="strict-decode">严格模式</label>
                            </div>
                        </div>
                        
                        <div class="input-section">
                            <label for="decode-input" class="input-label">Base64编码文本</label>
                            <textarea class="input-textarea" id="decode-input" placeholder="请输入要解码的Base64文本..."></textarea>
                        </div>
                        ...
                        <div class="output-section">
                            <label for="decode-output" class="output-label">解码结果</label>
                    ...
                    <div class="info-box">
                        <div class="info-title">关于Base64编码</div>
                        <div class="info-text">
                            Base64是一种基于64个可打印字符来表示二进制数据的编码方式，常用于需要通过文本协议传输二进制数据的场景。
                            <ul style="margin-top: 8px; padding-left: 20px;">
                                <li>标准Base64使用A-Z、a-z、0-9、+和/作为编码字符，=作为填充字符</li>
                                <li>URL安全Base64使用-和_替换+和/，不使用填充字符</li>
                                <li>Base64编码后的数据大小大约是原数据的1.33倍</li>
                                <li>Base64编码是可逆的，可以通过解码恢复原始数据</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function decodeBase64() {
            ...
            const strict = document.getElementById('strict-decode').checked;
            ...
            try {
                ...
                recordToolUsage('decode_success');
            } catch (e) {
                document.getElementById('decode-output').value = 'Decode failed: ' + e.message;
                updateDecodeStats(input, '');
                
    
                recordToolUsage('decode_error');
            }
        }
